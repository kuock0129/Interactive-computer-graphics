...
public:
    ...
    //     Color srgb = color.toSRGB();  // Convert to sRGB color space
    //     (*this)[y][x].r = static_cast<uint8_t>(255 * srgb.r);
    //     (*this)[y][x].g = static_cast<uint8_t>(255 * srgb.g);
    //     (*this)[y][x].b = static_cast<uint8_t>(255 * srgb.b);
    //     (*this)[y][x].a = 255;
    // }
